...
func createStudent(c *fiber.Ctx) error {
	...
	// NIM ganda dicek TERPISAH dari validasi field di atas, dan memakai 409,
	// bukan 422 — karena bentuk datanya sudah benar, tetapi bertentangan
	// dengan data yang sudah ada (soal "konflik", bukan soal "format salah").
	for _, s := range students {
		if s.NIM == req.NIM {
